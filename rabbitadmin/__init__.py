...
class Client(object):
    ...
    def put_exchange(self, vhost, exchange, type = 'direct', auto_delete = _NO_VALUE, durable = _NO_VALUE, internal = _NO_VALUE, arguments = _NO_VALUE):
        ...
        _all_data_args = { 'durable': durable, 'arguments': arguments, 'auto_delete': auto_delete, 'internal': internal, 'type': type,  }
        _data_args = {k: v for k, v in _all_query_args.items() if v != self._NO_VALUE}
    ...
    def post_exchange(self, vhost, exchange, properties, routing_key, payload, payload_encoding):
        ...
        _all_data_args = { 'payload_encoding': payload_encoding, 'properties': properties, 'routing_key': routing_key, 'payload': payload,  }
        _data_args = {k: v for k, v in _all_query_args.items() if v != self._NO_VALUE}
    ...
    def put_queue(self, vhost, queue, auto_delete = _NO_VALUE, durable = _NO_VALUE, arguments = _NO_VALUE, node = _NO_VALUE):
        ...
        _all_data_args = { 'durable': durable, 'auto_delete': auto_delete, 'node': node, 'arguments': arguments,  }
        _data_args = {k: v for k, v in _all_query_args.items() if v != self._NO_VALUE}
    ...
    def post_queue_get(self, vhost, queue, count = 1, requeue = True, encoding = 'auto', truncate = _NO_VALUE):
        ...
        _all_data_args = { 'encoding': encoding, 'requeue': requeue, 'count': count, 'truncate': truncate,  }
        _data_args = {k: v for k, v in _all_query_args.items() if v != self._NO_VALUE}
    ...
    def put_user(self, user, tags = '', password = _NO_VALUE, password_hash = _NO_VALUE):
        ...
        _all_data_args = { 'password': password, 'password_hash': password_hash, 'tags': tags,  }
        _data_args = {k: v for k, v in _all_query_args.items() if v != self._NO_VALUE}
    ...
    def put_user_vhost_permissions(self, vhost, user, configure, write, read):
        ...
        _all_data_args = { 'configure': configure, 'read': read, 'write': write,  }
        _data_args = {k: v for k, v in _all_query_args.items() if v != self._NO_VALUE}
    ...
    def put_parameter(self, component, vhost, parameter, name, value):
        ...
        _all_data_args = { 'vhost': vhost, 'component': component, 'value': value, 'name': name,  }
        _data_args = {k: v for k, v in _all_query_args.items() if v != self._NO_VALUE}
    ...
    def put_policy(self, vhost, policy, pattern, definition, priority = _NO_VALUE, apply_to = _NO_VALUE):
        ...
        _all_data_args = { 'definition': definition, 'pattern': pattern, 'priority': priority, 'apply-to': apply_to,  }
        _data_args = {k: v for k, v in _all_query_args.items() if v != self._NO_VALUE}
